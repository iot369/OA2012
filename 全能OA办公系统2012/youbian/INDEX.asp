...
<tr class="topbg"> <td WIDTH="27%"> <div align="center">省洲名称</div></td><td WIDTH="26%"> 
<div align="center">地区名称</div></td><td WIDTH="26%"> 
<div align="center">邮政编码</div></td><td WIDTH="21%"> 
<div align="center">电话区号</div></td></tr> <%
if sm<>"" then
...
do while (not rst.eof)
 %> <tr class="tdbg"> <td WIDTH="27%"><%=rst("sm")%>　</td><td WIDTH="26%"><%=rst("dq")%>　</td><td WIDTH="26%"><%
tmp=rst("yb")
if tmp="" then tmp="★★★"
response.write tmp
%>　</td><td WIDTH="21%"><%=rst("qh")
  %>　</td></tr> <%
rst.movenext
loop
rst.close
...
%> </table>
<table  width="96%" align="center" cellpadding="2" cellspacing="1" border="0" class="border"> 
<form name="form1" action="search.asp" method="post" > <tr class="topbg"> 
...
输入一个省名、地区名、邮编、区号,或其中一部分 </td></tr> 
</form>
<tr class="tdbg"> 
<td width="610" height="426" class="tdbg" colspan="5"><h2><img src="glasses.gif" webstripperlinkwas="images/glasses.gif" alt="WB00730_.gif (767 字节)" width="46" height="38"><a name="按地图位置查询">按地图位置查询</a></h2><p align="center"><map name="FPMap0"> 
