...
sql="select * from senddate,texttype where senddate.sender=" & sqlstr(oabusyusername) & " and senddate.reid=0 and texttype.number=senddate.documenttype order by senddate.id desc"
if request("lookfor")="yes" then sql="select * from senddate,texttype where senddate.sender=" & sqlstr(oabusyusername) & " and texttype.number=senddate.documenttype and senddate.reid=0 and senddate.inputdate between " & "#" & mydate & "# and #" & mydate1 & "# order by senddate.id desc"
	rs.open sql,conn,1
