...
sql="select * from userinf,getemailtable where getuserid="&cstr(oabusyuserid)&" and getemailtable.deleteflag=true and userinf.id=getemailtable.senduserid order by emaildate desc"
