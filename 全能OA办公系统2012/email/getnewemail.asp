...
sql="select * from userinf,getemailtable where getuserid="&cstr(oabusyuserid)&" and getemailtable.readflag=false and getemailtable.deleteflag=false and userinf.id=getemailtable.senduserid  order by emaildate desc"
