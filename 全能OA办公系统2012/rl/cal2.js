...
function mOvr(v) {
  ...
  if(sObj.innerHTML!='') {
      ...
      if(cld[d].solarTerms == '' && cld[d].solarFestival == '' && cld[d].lunarFestival == '')
         ...
         '<FONT COLOR="#000000" STYLE="font-size:9pt;">是日:'+cld[d].solarTerms + ' ' + cld[d].solarFestival + ' ' + cld[d].lunarFestival+'</FONT></TD>'+
         '</TR></TABLE>';
