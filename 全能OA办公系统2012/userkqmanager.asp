...
allow_edit_work_time=request("allow_edit_work_time")
if allow_edit_work_time="" then allow_edit_work_time="no"

allow_look_all_kq_info=request("allow_look_all_kq_info")
if allow_look_all_kq_info="" then allow_look_all_kq_info="no"

set conn=opendb("oabusy","conn","accessdsn")
sql="update userinf set "
sql=sql & "allow_look_all_kq_info=" & sqlstr(allow_look_all_kq_info) & ","
sql=sql & "allow_edit_work_time=" & sqlstr(allow_edit_work_time) & " where id=" & request("id")
conn.Execute sql
...
<td align=center>可设置单位上下班时间</td>
<td align=center>可查看单位所有员工考勤资料</td>
<td>&nbsp;</td>
</tr>
<%
'显示用户表
...
<td align=center><input type="checkbox" name="allow_edit_work_time" value="yes"<%=checked(rs("allow_edit_work_time"),"yes")%>></td>
<td align=center><input type="checkbox" name="allow_look_all_kq_info" value="yes"<%=checked(rs("allow_look_all_kq_info"),"yes")%>></td>
