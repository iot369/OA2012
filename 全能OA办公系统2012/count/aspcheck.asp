...
<TITLE>IT学习者ASP探针(ITlearner AspCheck) <%=hx.SysVersion%>－www.ITlearner.com</TITLE>
<style>
<!--
...
<table width="600" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center"><p><font size="6"><strong><a href="http://www.itlearner.com/aspcheck/" target="_blank">ASP 
        探针</a></strong></font> - <%=hx.SysVersion%>(<a href="http://www.itlearner.com" target="_blank">ITlearner</a>)</p>
      </td>
  </tr>
</table>
<br>
