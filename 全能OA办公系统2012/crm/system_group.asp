...
Function list()
    ...
    Do While Not rs.BOF And Not rs.EOF
    	...
    	strToPrint = strToPrint & "          <td align=""center"">[<a href=""?action=edit&gNameOld=" & rs("gName") & """>修改</a>] [<a href=""?action=delete&gNameOld=" & rs("gName") & """ onClick=""return confirm('确定要删除该组和\r该组内所有用户？');"">删除</a>]</td>" & VBCrlf
    	rs.MoveNext
    Loop
    rs.Close
    Set rs = Nothing
...
%>
		    <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
              ...
              <tr> 
                <td width="60">&nbsp;</td>
                  <td>用户组名称： 
                    <input name="gName" type="text" id="gName" size="16" maxlength="16" value="<% = gName %>" selfValue="用户级别名称">
                    组编号： 
                    <input name="gId" type="text" id="gId" size="2" maxlength="2" value="<% = gId %>" selfValue="级别编号">
                  </td>
              </tr>
              <tr> 
...
%>
  ...
  [<a href="system_area.asp">业务区域</a>] [<a href="system_square.asp">业务小区</a>] [<a href="system_del1.asp">客户删除</a>] [<a href="system_del2.asp">记录删除</a>] [<a href="system_del3.asp">拜访删除</a>] </div></td>
      ...
      <table width="100%" align="center" border="1" cellpadding="3" cellspacing="0" bordercolor="#DCDCDC" bordercolordark="#FFFFFF">
        <tr> 
          <td width="120" align="center" bgcolor="menu">组编号</td>
