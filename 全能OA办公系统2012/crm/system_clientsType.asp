...
Function list()
    ...
    '	strToPrint = strToPrint & "          <td align=""center"">" & rs("lId") & "</td>" & VBCrlf
    	...
    	strToPrint = strToPrint & "          <td align=""center"">[<a href=""?action=edit&clientsTypeOld=" & rs("clientsType") & """>修改</a>] [<a href=""?action=delete&clientsTypeOld=" & rs("clientsType") & """ onClick=""return confirm('确定要删除该客户类型和该\r类型下的所有客户资料？');"">删除</a>]</td>" & VBCrlf
    	rs.MoveNext
    Loop
    rs.Close
    Set rs = Nothing
...
Sub saveData()
	...
	If rs.RecordCount > 0 Then
	    Response.Write("<div align=""center"">该客户类型已经存在。<br>")
		Response.Write("<input name=""back"" type=""button"" value="" 返 回 "" onClick=""history.back();""></div>")
		rs.Close
		Set rs = Nothing
		Exit Sub
...
%>
		    <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
              ...
              <tr> 
                <td width="60">&nbsp;</td>
                  <td>客户类型名称： 
                    <input name="clientsType" type="text" id="clientsType" size="16" maxlength="16" value="<% = clientsType %>" selfValue="客户类别名称">
                  </td>
              </tr>
              <tr> 
