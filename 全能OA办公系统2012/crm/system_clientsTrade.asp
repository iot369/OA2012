...
Function list()
    ...
    '	strToPrint = strToPrint & "          <td align=""center"">" & rs("lId") & "</td>" & VBCrlf
    	...
    	strToPrint = strToPrint & "          <td align=""center"">[<a href=""?action=edit&clientsTradeOld=" & rs("clientsTrade") & """>修改</a>] [<a href=""?action=delete&clientsTradeOld=" & rs("clientsTrade") & """ onClick=""return confirm('确定要删除该客户类型和该\r类型下的所有客户资料？');"">删除</a>]</td>" & VBCrlf
    	rs.MoveNext
    Loop
    rs.Close
    Set rs = Nothing
...
Sub saveData()
	...
	If rs.RecordCount > 0 Then
	    Response.Write("<div align=""center"">该行业类型已经存在。<br>")
		Response.Write("<input name=""back"" type=""button"" value="" 返 回 "" onClick=""history.back();""></div>")
		rs.Close
		Set rs = Nothing
		Exit Sub
...
%>
		    <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
              ...
              <tr> 
                <td width="60">&nbsp;</td>
                  <td>行业类型名称： 
                    <input name="clientsTrade" type="text" id="clientsTrade" size="16" maxlength="16" value="<% = clientsTrade %>" selfValue="客户类别名称">
                  </td>
              </tr>
              <tr> 
...
[<a href="system_area.asp">业务区域</a>] [<a href="system_square.asp">业务小区</a>] [<a href="system_del1.asp">客户删除</a>] [<a href="system_del2.asp">记录删除</a>] [<a href="system_del3.asp">拜访删除</a>] </div></td>
      ...
      <table width="100%" align="center" border="1" cellpadding="3" cellspacing="0" bordercolor="#DCDCDC" bordercolordark="#FFFFFF">
        <tr> 
          <td align="center" bgcolor="menu">客户类型名称</td>
