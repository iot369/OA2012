...
Do While Not rs.BOF And Not rs.EOF
    i = i + 1
	strToPrint = strToPrint & "        <tr bgcolor=""#FFffff"">" & VBCrlf
...
Sub addForm()
%>
      <table width="550" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
...
Sub saveData()
	...
	If uAccount = "" Or uPassword = "" Or uPassword <> uConfirmPWS Or uName = "" Or uGroup = "" Then
	    Response.Redirect("manageUser.asp?errMsg=2")
	End If
	Set rs = Server.CreateObject("ADODB.Recordset")
...
Sub editForm()
	...
	If Not IsNumeric(uId) Or uId <= 0 Then Response.Redirect("manageUser.asp?errMsg=1")
	Dim uAccount,uPassword,uName,uLevel,uGroup
	Set rs = Server.CreateObject("ADODB.Recordset")
	rs.Open "Select * From baidu_user Where uId = " & uId,conn,3,1
	If rs.RecordCount <> 1 Then Response.Redirect("manageUser.asp?errMsg=1")
    ...
    <td valign="top" bgcolor="#FFFFFF" style="padding: 10px;"> 
      <table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="right"> [<a href="manageUser.asp">用户列表</a>] [<a href="manageUser.asp">新建用户</a>]</td>
        </tr>
      </table> 
      <table width="550" align="center" border="1" cellpadding="3" cellspacing="0" bordercolor="#DCDCDC" bordercolordark="#FFFFFF">
        <tr>
          <td width="40" align="center" bgcolor="menu">编号</td>
          <td width="68" align="center" bgcolor="menu">账号</td>
          <td width="66" align="center" bgcolor="menu">密码</td>
          <td width="64" align="center" bgcolor="menu">真实姓名</td>
          <td width="80" align="center" bgcolor="menu">所属小组</td>
          <td width="60" align="center" bgcolor="menu">用户等级</td>
          <td width="114" align="center" bgcolor="menu">操作</td><% = strToPrint %>
        </tr>
      </table></td>
  </tr>
  <tr>
