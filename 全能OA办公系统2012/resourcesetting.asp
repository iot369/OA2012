...
allow_add_resource=request("allow_add_resource")
if allow_add_resource="" then allow_add_resource="no"

allow_check_resource_requirement=request("allow_check_resource_requirement")
if allow_check_resource_requirement="" then allow_check_resource_requirement="no"

set conn=opendb("oabusy","conn","accessdsn")
sql="update userinf set "
sql=sql & "allow_check_resource_requirement=" & sqlstr(allow_check_resource_requirement) & ","
sql=sql & "allow_add_resource=" & sqlstr(allow_add_resource) & " where id=" & request("id")
conn.Execute sql
...
rs.open sql,conn,1
%>
<form method="post" action="resourcesetting.asp">
<td>
...
<td align=center>可增加/删除资源</td>
<td align=center>可审批资源预约</td>
<td>&nbsp;</td>
</tr>
<%
'显示用户表
...
<td align=center><input type="checkbox" name="allow_add_resource" value="yes" <%=checked(rs("allow_add_resource"),"yes")%>></td>
<td align=center><input type="checkbox" name="allow_check_resource_requirement" value="yes" <%=checked(rs("allow_check_resource_requirement"),"yes")%>></td>
